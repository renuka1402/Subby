...
const DetailsForm = ({ navigation }) => {
  ...
  const handleForm = async () => {
    ...
    if (!firstname || !surname || !email || !address || !city || !postcode || !country || !companyReg || !utr || !phone) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.logoutButton} onPress={handleForm}>
        <Text style={styles.logoutText}>Update Details</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
