    ...
    <View style={styles.wrapper}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <Text style={styles.welcomeText}>
          WELCOME BACK {homeData?.user_name?.toUpperCase() || "REYAND SHARMA"}!
        </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.workspaceRow}>
            ...
            <Text style={styles.workspaceText}>{homeData?.workspace_name || "Test company by yash"}</Text>
          </View>
        </View>

        <View style={styles.section1}>
          <Text style={styles.sectionTitle1}>NEXT PAYMENT DUE / STATUS</Text>
          <Text style={styles.paymentStatus}>{homeData?.payment_status || "PENDING YOUR TIMESHEET"}</Text>
        </View>
